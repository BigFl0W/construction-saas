...
header('Location: service_manager.php?service=building-construction');
exit;

function serviceHandleAssetUpload($fileKey, $targetName, $subDirectory = 'services/building-construction') {
...
$serviceCtaButtonLink = $settings->get('service_bc_cta_button_link', 'contact-us/');
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (!$auth->verifyCsrfToken($_POST['csrf_token'] ?? '')) {
        ...
        try {
            ...
            $assetMap = [
                'service_bc_gallery_1_file' => ['target' => 'gallery-1', 'setting' => 'service_bc_gallery_1'],
                'service_bc_gallery_2_file' => ['target' => 'gallery-2', 'setting' => 'service_bc_gallery_2'],
                'service_bc_gallery_3_file' => ['target' => 'gallery-3', 'setting' => 'service_bc_gallery_3'],
                'service_bc_gallery_4_file' => ['target' => 'gallery-4', 'setting' => 'service_bc_gallery_4'],
                'service_bc_gallery_5_file' => ['target' => 'gallery-5', 'setting' => 'service_bc_gallery_5'],
                'service_bc_gallery_6_file' => ['target' => 'gallery-6', 'setting' => 'service_bc_gallery_6'],
                'service_bc_sustainable_image_1_file' => ['target' => 'sustainable-1', 'setting' => 'service_bc_sustainable_image_1'],
                'service_bc_sustainable_image_2_file' => ['target' => 'sustainable-2', 'setting' => 'service_bc_sustainable_image_2'],
                'service_bc_cta_image_file' => ['target' => 'cta-image', 'setting' => 'service_bc_cta_image'],
                'service_bc_contact_image_file' => ['target' => 'contact-image', 'setting' => 'service_bc_contact_image'],
            ];
            ...
            $_SESSION['toast_success'] = 'Building Construction page updated successfully.';
        } catch (Throwable $e) {
            $_SESSION['toast_error'] = $e->getMessage();
        }
    }

    header('Location: service_building_construction_settings.php');
    exit;
}

$pageActive = 'service_building_construction_settings';
$pageTitle = 'TPV Construction and Services LTD · Building Construction Settings';
    ...
    <div class="container-fluid p-l-15 p-r-15 sm-p-l-0 sm-p-r-0">
        <div class="inner">
            <ol class="breadcrumb sm-p-b-5">
                ...
                <li class="breadcrumb-item active">Building Construction Settings</li>
            </ol>
        </div>
    </div>
</div>
    ...
    <form method="POST" enctype="multipart/form-data">
            ...
            <div class="card-body">
                <div class="row g-4">
                    <div class="col-md-6">
                        ...
                        <input type="hidden" name="groups[service_bc_page_title]" value="services">
                        <input type="text" name="settings[service_bc_page_title]" class="form-control" value="<?php echo htmlspecialchars($serviceTitle); ?>">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label fw-semibold">Overview Card Title</label>
                        <input type="hidden" name="groups[service_bc_overview_title]" value="services">
                        <input type="text" name="settings[service_bc_overview_title]" class="form-control" value="<?php echo htmlspecialchars($serviceOverviewTitle); ?>">
                    </div>
                    <div class="col-12">
                        <label class="form-label fw-semibold">Overview Card Body</label>
                        <input type="hidden" name="groups[service_bc_overview_body]" value="services">
                        <textarea name="settings[service_bc_overview_body]" class="form-control" rows="3"><?php echo htmlspecialchars($serviceOverviewBody); ?></textarea>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label fw-semibold">Highlight Card 2 Title</label>
                        <input type="hidden" name="groups[service_bc_highlight_2_title]" value="services">
                        <input type="text" name="settings[service_bc_highlight_2_title]" class="form-control" value="<?php echo htmlspecialchars($serviceHighlight2Title); ?>">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label fw-semibold">Highlight Card 3 Title</label>
                        <input type="hidden" name="groups[service_bc_highlight_3_title]" value="services">
                        <input type="text" name="settings[service_bc_highlight_3_title]" class="form-control" value="<?php echo htmlspecialchars($serviceHighlight3Title); ?>">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label fw-semibold">Highlight Card 2 Body</label>
                        <input type="hidden" name="groups[service_bc_highlight_2_body]" value="services">
                        <textarea name="settings[service_bc_highlight_2_body]" class="form-control" rows="3"><?php echo htmlspecialchars($serviceHighlight2Body); ?></textarea>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label fw-semibold">Highlight Card 3 Body</label>
                        <input type="hidden" name="groups[service_bc_highlight_3_body]" value="services">
                        <textarea name="settings[service_bc_highlight_3_body]" class="form-control" rows="3"><?php echo htmlspecialchars($serviceHighlight3Body); ?></textarea>
                    </div>
                    <div class="col-12">
                        <label class="form-label fw-semibold">Main Content Paragraph</label>
                        <input type="hidden" name="groups[service_bc_content_body]" value="services">
                        <textarea name="settings[service_bc_content_body]" class="form-control" rows="4"><?php echo htmlspecialchars($serviceContentBody); ?></textarea>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card-body">
                <div class="row g-4">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="file" name="service_bc_gallery_<?php echo $index; ?>_file" class="form-control" accept=".png,.jpg,.jpeg,.svg,.webp">
                    </div>
                    <?php endforeach; ?>
                    <div class="col-md-6">
                        ...
                        <input type="file" name="service_bc_sustainable_image_1_file" class="form-control" accept=".png,.jpg,.jpeg,.svg,.webp">
                    </div>
                    <div class="col-md-6">
                        ...
                        <input type="file" name="service_bc_sustainable_image_2_file" class="form-control" accept=".png,.jpg,.jpeg,.svg,.webp">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card-body">
                <div class="row g-4">
                    <div class="col-md-6">
                        ...
                        <input type="hidden" name="groups[service_bc_feature_1]" value="services">
                        <input type="text" name="settings[service_bc_feature_1]" class="form-control" value="<?php echo htmlspecialchars($serviceFeature1); ?>">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label fw-semibold">Feature 2</label>
                        <input type="hidden" name="groups[service_bc_feature_2]" value="services">
                        <input type="text" name="settings[service_bc_feature_2]" class="form-control" value="<?php echo htmlspecialchars($serviceFeature2); ?>">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label fw-semibold">Feature 3</label>
                        <input type="hidden" name="groups[service_bc_feature_3]" value="services">
                        <input type="text" name="settings[service_bc_feature_3]" class="form-control" value="<?php echo htmlspecialchars($serviceFeature3); ?>">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label fw-semibold">Feature 4</label>
                        <input type="hidden" name="groups[service_bc_feature_4]" value="services">
                        <input type="text" name="settings[service_bc_feature_4]" class="form-control" value="<?php echo htmlspecialchars($serviceFeature4); ?>">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label fw-semibold">Feature 5</label>
                        <input type="hidden" name="groups[service_bc_feature_5]" value="services">
                        <input type="text" name="settings[service_bc_feature_5]" class="form-control" value="<?php echo htmlspecialchars($serviceFeature5); ?>">
                    </div>
                    <div class="col-12">
                        <label class="form-label fw-semibold">Sustainable Section Title</label>
                        <input type="hidden" name="groups[service_bc_sustainable_title]" value="services">
                        <input type="text" name="settings[service_bc_sustainable_title]" class="form-control" value="<?php echo htmlspecialchars($serviceSustainableTitle); ?>">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label fw-semibold">Sustainable Paragraph 1</label>
                        <input type="hidden" name="groups[service_bc_sustainable_body_1]" value="services">
                        <textarea name="settings[service_bc_sustainable_body_1]" class="form-control" rows="4"><?php echo htmlspecialchars($serviceSustainableBody1); ?></textarea>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label fw-semibold">Sustainable Paragraph 2</label>
                        <input type="hidden" name="groups[service_bc_sustainable_body_2]" value="services">
                        <textarea name="settings[service_bc_sustainable_body_2]" class="form-control" rows="4"><?php echo htmlspecialchars($serviceSustainableBody2); ?></textarea>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card-body">
                <div class="row g-4">
                    <div class="col-md-4">
                        ...
                        <input type="hidden" name="groups[service_bc_process_eyebrow]" value="services">
                        <input type="text" name="settings[service_bc_process_eyebrow]" class="form-control" value="<?php echo htmlspecialchars($serviceProcessEyebrow); ?>">
                    </div>
                    <div class="col-md-8">
                        <label class="form-label fw-semibold">Section Title</label>
                        <input type="hidden" name="groups[service_bc_process_title]" value="services">
                        <input type="text" name="settings[service_bc_process_title]" class="form-control" value="<?php echo htmlspecialchars($serviceProcessTitle); ?>">
                    </div>
                    <div class="col-12">
                        <label class="form-label fw-semibold">Section Body</label>
                        <input type="hidden" name="groups[service_bc_process_body]" value="services">
                        <textarea name="settings[service_bc_process_body]" class="form-control" rows="4"><?php echo htmlspecialchars($serviceProcessBody); ?></textarea>
                    </div>
                    <?php for ($step = 1; $step <= 3; $step++): ?>
                    <div class="col-md-4">
                        <label class="form-label fw-semibold">Step <?php echo $step; ?> Title</label>
                        <input type="hidden" name="groups[service_bc_step_<?php echo $step; ?>_title]" value="services">
                        <input type="text" name="settings[service_bc_step_<?php echo $step; ?>_title]" class="form-control" value="<?php echo htmlspecialchars(${'serviceStep' . $step . 'Title'}); ?>">
                    </div>
                    <div class="col-md-8">
                        <label class="form-label fw-semibold">Step <?php echo $step; ?> Body</label>
                        <input type="hidden" name="groups[service_bc_step_<?php echo $step; ?>_body]" value="services">
                        <textarea name="settings[service_bc_step_<?php echo $step; ?>_body]" class="form-control" rows="3"><?php echo htmlspecialchars(${'serviceStep' . $step . 'Body'}); ?></textarea>
                    </div>
                    <?php endfor; ?>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="row g-4">
                    <div class="col-md-6">
                        ...
                        <input type="hidden" name="groups[service_bc_cta_title]" value="services">
                        <textarea name="settings[service_bc_cta_title]" class="form-control" rows="2"><?php echo htmlspecialchars($serviceCtaTitle); ?></textarea>
                    </div>
                    <div class="col-md-6">
                        ...
                        <input type="file" name="service_bc_cta_image_file" class="form-control" accept=".png,.jpg,.jpeg,.svg,.webp">
                    </div>
                    <div class="col-12">
                        <label class="form-label fw-semibold">CTA Body</label>
                        <input type="hidden" name="groups[service_bc_cta_body]" value="services">
                        <textarea name="settings[service_bc_cta_body]" class="form-control" rows="3"><?php echo htmlspecialchars($serviceCtaBody); ?></textarea>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label fw-semibold">CTA Button Text</label>
                        <input type="hidden" name="groups[service_bc_cta_button_text]" value="services">
                        <input type="text" name="settings[service_bc_cta_button_text]" class="form-control" value="<?php echo htmlspecialchars($serviceCtaButtonText); ?>">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label fw-semibold">CTA Button Link</label>
                        <input type="hidden" name="groups[service_bc_cta_button_link]" value="services">
                        <input type="text" name="settings[service_bc_cta_button_link]" class="form-control" value="<?php echo htmlspecialchars($serviceCtaButtonLink); ?>">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label fw-semibold">Support Title</label>
                        <input type="hidden" name="groups[service_bc_support_title]" value="services">
                        <input type="text" name="settings[service_bc_support_title]" class="form-control" value="<?php echo htmlspecialchars($serviceSupportTitle); ?>">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label fw-semibold">Support Body</label>
                        <input type="hidden" name="groups[service_bc_support_body]" value="services">
                        <input type="text" name="settings[service_bc_support_body]" class="form-control" value="<?php echo htmlspecialchars($serviceSupportBody); ?>">
                    </div>
                    <div class="col-md-4">
                        <label class="form-label fw-semibold">Phone Label</label>
                        <input type="hidden" name="groups[service_bc_phone_label]" value="services">
                        <input type="text" name="settings[service_bc_phone_label]" class="form-control" value="<?php echo htmlspecialchars($servicePhoneLabel); ?>">
                    </div>
                    <div class="col-md-4">
                        <label class="form-label fw-semibold">Email Label</label>
                        <input type="hidden" name="groups[service_bc_email_label]" value="services">
                        <input type="text" name="settings[service_bc_email_label]" class="form-control" value="<?php echo htmlspecialchars($serviceEmailLabel); ?>">
                    </div>
                    <div class="col-md-4">
                        ...
                        <input type="file" name="service_bc_contact_image_file" class="form-control" accept=".png,.jpg,.jpeg,.svg,.webp">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label fw-semibold">Contact Form Eyebrow</label>
                        <input type="hidden" name="groups[service_bc_contact_eyebrow]" value="services">
                        <input type="text" name="settings[service_bc_contact_eyebrow]" class="form-control" value="<?php echo htmlspecialchars($serviceContactEyebrow); ?>">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label fw-semibold">Contact Form Title</label>
                        <input type="hidden" name="groups[service_bc_contact_title]" value="services">
                        <input type="text" name="settings[service_bc_contact_title]" class="form-control" value="<?php echo htmlspecialchars($serviceContactTitle); ?>">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="d-flex justify-content-end">
            <button type="submit" class="btn btn-primary px-4 py-2">
                ...
                Save Building Construction Page
            </button>
        </div>
    </form>
</div>
