				...
				<div class="elementor-element elementor-element-f18f202 e-con-full e-flex e-con e-child"
					...
					<div class="elementor-element elementor-element-f8fca35 e-con-full e-flex elementor-invisible e-con e-child"
                        ...
                        <div class="contact-form elementor-widget">
                            <div class="elementor-widget-container">
                                <?php
                                $contactSentCf = isset($_GET['sent']);
                                $contactErrorsCf = $_SESSION['contact_errors'] ?? [];
                                $contactOldCf = $_SESSION['contact_old'] ?? [];
                                unset($_SESSION['contact_errors'], $_SESSION['contact_old']);
                                ?>
                                <?php if ($contactSentCf): ?>
                                ...
                                <div class="alert alert-danger py-3" style="background:rgba(239,68,68,0.15);border:1px solid rgba(239,68,68,0.3);border-radius:10px;color:#fff;">
                                    <ul class="mb-0" style="list-style:none;padding:0;">
                                        <?php foreach ($contactErrorsCf as $err): ?>
                                ...
                                <form action="contact_process.php" method="post" novalidate>
                                    <div class="row">
                                        <div class="form-group col-md-6 mb-4">
                                            <input size="40" class="form-control" placeholder="Your Full Name *" type="text" name="name" value="<?php echo htmlspecialchars($contactOldCf['name'] ?? ''); ?>" required>
                                        </div>
                                        <div class="form-group col-md-6 mb-4">
                                            <input size="40" class="form-control" placeholder="Email Address *" type="email" name="email" value="<?php echo htmlspecialchars($contactOldCf['email'] ?? ''); ?>" required>
                                        </div>
                                        <div class="form-group col-md-6 mb-4">
                                            <input size="40" class="form-control" placeholder="Phone Number *" type="text" name="phone" value="<?php echo htmlspecialchars($contactOldCf['phone'] ?? ''); ?>" required>
                                        </div>
                                        <div class="form-group col-md-6 mb-4">
                                            <input size="40" class="form-control" placeholder="Subject *" type="text" name="subject" value="<?php echo htmlspecialchars($contactOldCf['subject'] ?? ''); ?>" required>
                                        </div>
                                        <div class="form-group col-md-12 mb-4">
                                            <textarea cols="40" rows="5" maxlength="2000" class="form-control" placeholder="Tell us about your project..." name="message" required><?php echo htmlspecialchars($contactOldCf['message'] ?? ''); ?></textarea>
                                        </div>
